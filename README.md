...
* **Side Force (Fy):** In this tool, Side Force remains constant across the slip range because the implementation utilizes the **Pure Slip** equations for a fixed slip angle. 
